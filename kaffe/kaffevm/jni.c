...
Kaffe_NewObjectV(JNIEnv* env, jclass cls, jmethodID meth, va_list args)
{
	...
	callMethodV(m, m, obj, args, &retval);
...
Kaffe_NewObjectA(JNIEnv* env, jclass cls, jmethodID meth, jvalue* args)
{
	...
	callMethodA(m, m, obj, args, &retval);
